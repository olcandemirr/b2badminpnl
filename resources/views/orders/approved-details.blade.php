...
$(document).ready(function() {
    ...
    $('#searchButton').click(function() {
        ...
        window.location.href = `/orders/approved/details?start_date=${startDate}&end_date=${endDate}&search=${searchQuery}`;
    });
    ...
    $('#exportExcel').click(function() {
        ...
        window.location.href = `/orders/approved/details/export?start_date=${startDate}&end_date=${endDate}&search=${searchQuery}`;
    });
});
</script>
@endpush 