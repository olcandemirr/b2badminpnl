    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <!-- İçerik Ekleme Formu -->
                    <form id="contentForm" action="{{ route('definitions.contents.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="eng" class="form-label">Başlık (İngilizce)</label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control editor" id="description" name="description" rows="5"></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="eng_description" class="form-label">Açıklama (İngilizce)</label>
                                    <textarea class="form-control editor" id="eng_description" name="eng_description" rows="5"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <button type="submit" class="btn btn-primary">İÇERİĞİ EKLE</button>
                    </form>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($content->photo)
                                            <img src="{{ asset('uploads/contents/' . $content->photo) }}" 
                                                alt="İçerik Görseli" 
                                                style="max-width: 50px; max-height: 50px;">
                                        @endif
                                    </td>
                                    <td>{{ Str::limit($content->link, 20) }}</td>
                                    <td>
